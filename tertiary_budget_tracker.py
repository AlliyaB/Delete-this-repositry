...
def open_main_code():
    ...
    def open_income_window():
        ...
        def create_table():
            ...
            def income_next():
                """Function to save the user income, validate their entries,
                and redirect to expenses page.
                """
    ...
    def open_expenses_window():
        ...
        def create_table():
            ...
            def expenses_next():
                """Function to save the user expenses, validate their entries,
                and redirect to expenses page.
                """
    ...
    def open_insights_window():
        ...
        def exit_insights_window():
            """Function to ensure the user wants to exit the insight_window."""
            response = messagebox.askquestion("Exit Programme?","Your "
                                              "progress will NOT be saved."
                                              "\nAre you sure you want to "
                                              "exit the program?",
    ...
    def insights_to_expenses():
        """Function to take the user from insights page to expenses page."""
        insights_window.destroy()
        open_expenses_window()

    def insights_to_income():
        """Function to take the user from insights page to income page."""
        insights_window.destroy()
        open_income_window()
    ...
    def expenses_to_insights():
        """Function to take the user from expenses page to insights page."""
        expenses_window.destroy()
    ...
    def insights_to_about():
        """Function to take the user from insights page to about page."""
...
def expenses_to_main():
    """Function to redirect user to the main code via expenses window."""
...
def insights_to_main():
    """Function to redirect user to the main code via insights window."""
    response = messagebox.askquestion("Exit my insights?","Your progress "
                                          "will NOT be saved.\nAre you sure "
                                          "you want to go home page?",
    icon = 'warning')
